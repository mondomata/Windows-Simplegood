...
- A Windows telepítő programban a meglévő/foglalt, **0.lemez - Windows partíciót válaszd** <sup>(*...ha feljegyezted a C: meghajtó méretét (GB), akkor látni fogod: az a Windows partíció, amelyiknek a mérete egyezik a C:-vel; egyébként pedig általában a 0.lemez 'első' olyan partíciója a Windows-é, amelyik nagyobb 52 GB-nál, azaz több, mint 53000 MB... Ha korábban nem készült több partíció a gépeden, akkor egyértelmű lesz, mert a System/Rendszer partíció, valamint a Recovery/Helyreállítás partíción kívül mindössze 2 foglalt partíciód lesz a Telepítő szerint a lemezeden: a Windowsé, és a kb. 10000 MB-os telepítő partíciód, amit az 1. pont szerint készítettél. Az alábbi képen egy példát látsz a Telepítőből a partíció választásra...*)</sup>
<img width="325" height="100" alt="{CB32250E-355D-4BDC-B982-A4E45EDCC5CF}" src="https://github.com/user-attachments/assets/26eafdf5-7834-430e-b06f-6750b2e27761" />

- A **<kbd>[Telepítés]</kbd>** gombra kattintva megkezdődik a folyamat (visszavonhatatlan), a régi Windowst az új Windows felülírja (**🧨MINDENT TÖRÖL: személyes fájlok, programok, beállítások, stb!🧼**)
> [!TIP]
