...
- A Windows telepítő programban a meglévő **0.lemez - Windows** partíciót válaszd (*...ha feljegyezted a C: meghajtó méretét (GB), akkor látni fogod: az a Windows partíció, amelyiknek a mérete egyezik a C:-vel; egyébként pedig általában a 0.lemez 'legfelső' olyan partíciója a Windows-é, amelyik nagyobb 50000 MB-nál (50 GB-nál).* A **<kbd>[Telepítés]</kbd>** gombra kattintva megkezdődik a folyamat (visszavonhatatlan), a régi Windowst az új Windows felülírja (**🧨MINDENT TÖRÖL: személyes fájlok, programok, beállítások, stb!🧼**)
> [!TIP]
