...
- **Windows Helyreállítási Módban újraindítás**: ezt a módot a Tálca/Start menüben a <kbd>Shift</kbd> nyomva tartása közben a <kbd>(|)</kbd>*Kikapcsolás*/**Újraindítás**-ra kattintva lehet elindítani, vagy a Windows *Powershell (Win10=Terminál)* programban a **shutdown /r /o** begépelésével és <kbd>[Enter]</kbd>-rel,
