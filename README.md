...
- **Windows Helyreállítási Újraindítás**: ez a Tálca Start &plusb; ikonra, majd a <kbd>(|)</kbd>*Főkapcsoló* > **Újraindítás**-ra a <kbd>Shift</kbd> billentyű *nyomva tartása közben* rákattintva lehetséges. Más módon: a Windows *Powershell (vagy Terminál)* programban **shutdown /r /o** begépelésével és <kbd>[&#8629;Enter]</kbd>-rel indul, (kb.1perc...)
