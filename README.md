...
- A Windows telepítő programban a meglévő/foglalt, **0.lemez - "?" (Windows) primary/elsődleges partíciót válaszd eszerint:** *...ha feljegyezted a C: meghajtó méretét (GB), akkor látni fogod: az a Windows partíció, amelyiknek a mérete egyezik a C:-vel; egyébként pedig általában a 0.lemez 'első' olyan partíciója a Windows-é, amelyik nagyobb 52 GB-nál, azaz több, mint 53000 MB... Ha korábban nem készült több partíció a gépeden, akkor egyértelmű lesz, mert a System/Rendszer partíció, valamint a Recovery/Helyreállítás partíción kívül mindössze 2 foglalt partíciód lesz a Telepítő szerint a lemezeden: a Windowsé, és a kb. 10000 MB-os telepítő partíciód, amit az 1. pont szerint készítettél.* <sup>(Az alábbi képen egy lehetséges példát látsz a Telepítőből a Windows partíció választásra...)</sup>
