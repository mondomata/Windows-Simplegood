...
- **Windows Helyreállítási Újraindítás**: ezt a Start &plusb; ikonra kattintva a <kbd>Shift</kbd> billentyű nyomva tartása közben pedig a <kbd>(|)</kbd>*Főkapcsoló* **Újraindítás**-ra kattintva lehet elindítani. Másik mód: a Windows *Powershell (vagy Terminál)* programban a ***shutdown /r /o*** begépelésével és <kbd>[&#8629;Enter]</kbd>-rel, (kb.1perc...)
