...
- **Windows Helyreállítási Újraindítás**: ezt a Tálca/Start menüben a <kbd>Shift</kbd> billentyű nyomva tartása közben a <kbd>(|)</kbd>*Kikapcsolás*/**Újraindítás**-ra kattintva lehet elindítani, vagy a Windows *Powershell (Win10=Terminál)* programban a **shutdown /r /o** begépelésével és <kbd>[Enter]</kbd>-rel, (kb.1perc....)
