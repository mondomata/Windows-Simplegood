...
- A Windows telepítő programban a meglévő **0.lemez - Windows** partíciót válaszd (*...ha feljegyezted a C: meghajtó méretét (GB), akkor látni fogod: az a Windows partíció, amelyiknek a mérete egyezik a C:-vel; egyébként pedig általában a 0.lemez 'első' olyan partíciója a Windows-é, amelyik nagyobb 52 GB-nál, azaz több, mint 53000 MB.../semmiképp ne válaszd a Recovery, vagy System feliratút/)* A **<kbd>[Telepítés]</kbd>** gombra kattintva megkezdődik a folyamat (visszavonhatatlan), a régi Windowst az új Windows felülírja (**🧨MINDENT TÖRÖL: személyes fájlok, programok, beállítások, stb!🧼**)
> [!TIP]
